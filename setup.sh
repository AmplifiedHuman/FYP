...
ovs-docker del-port ovs-br4 eth4 firewall
ovs-docker add-port ovs-br4 eth4 firewall --ipaddress=192.168.3.2/24
...
ovs-docker del-port ovs-br4 eth4 suricata
ovs-docker add-port ovs-br4 eth4 suricata --ipaddress=192.168.3.3/24